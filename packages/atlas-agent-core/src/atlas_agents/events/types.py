...
class AgentEventType(StrEnum):
    ...
    GUARDRAIL_EVALUATION_STARTED = "guardrail_evaluation_started"
    GUARDRAIL_EVALUATION_COMPLETED = "guardrail_evaluation_completed"
    GUARDRAIL_TRANSFORMED = "guardrail_transformed"
