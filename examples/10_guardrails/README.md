...
Exibir decisões ALLOW, TRANSFORM e REJECT como política explícita.

## Conceitos demonstrados

GuardrailPipeline, estágios e enforcement.
...
`uv run python examples/10_guardrails/main.py`

## Saída esperada

As três decisões e seus outputs esperados.
