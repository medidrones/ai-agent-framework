...
Registrar, validar e executar uma ferramenta local explícita.

## Conceitos demonstrados

ToolDefinition, ToolRegistry e ToolExecutor.
...
`uv run python examples/05_tools/main.py`

## Saída esperada

Resultado calculado após dois turnos.
