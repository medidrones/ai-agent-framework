...
Demonstrar modelo, ferramenta e novo turno de modelo.

## Conceitos demonstrados

Histórico, tool call e encerramento determinístico.
...
`uv run python examples/06_multi_turn/main.py`

## Saída esperada

Resposta final produzida depois da ferramenta.
