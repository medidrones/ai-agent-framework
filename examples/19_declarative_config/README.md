...
Carregar YAML estrito e construir uma composição por factory tipada.

## Conceitos demonstrados

load_yaml, factory registry e AtlasCompositionBuilder.
...
`uv run python examples/19_declarative_config/main.py`

## Saída esperada

Agente declarativo e saída da composição.
...
atlas-agent-config. Consulte também a [visão arquitetural](../../docs/architecture/overview.md) e o [índice dos exemplos](../README.md).
